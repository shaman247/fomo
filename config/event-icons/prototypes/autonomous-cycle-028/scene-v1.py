...
flat_extrude('flat card blank',[(.048,-.035),(.102,-.035),(.102,.012),(.075,.035),(.048,.012)],0,.001,'#E8C58B')
rod('craft brush handle',(.077,.003,.055),(.13,.003,-.028),.0028,'#6C949A',10)
rod('craft brush ferrule',(.071,.003,.064),(.077,.003,.055),.0034,'#A8B5B0',10)
rod('craft brush bristles',(.062,.003,.078),(.071,.003,.064),.0004,'#8C7056',10,r2=.0034)
