...
b=Path('.scratch/icon-cycles-20260909/cycle-025');out=b
...
def project(s):
 ...
 for p in s['parts']:
  ...
  for fidx in p['faces']:
   ...
   if p['name'] in ['virtual clay paint','leaf vein','screen diamond','grille mark','tension rope','die edge','joining stitch','lace thread']:factor=1
