...
box('motor bracket',(0,.085,-.015),(.022,.006,.029),'#AD8A70')
rod('motor body',(0,.088,-.015),(0,.11,-.015),.01,'#A2B2B2',n=16)
rod('motor shaft',(0,.11,-.015),(0,.118,-.015),.0018,'#5F747A',n=10)
rod('offset arm',(0,.118,-.015),(.011,.118,-.015),.0022,'#8C7967',n=8)
ball('offset mass',(.011,.118,-.015),.004,'#C88B75')
...
for j,(x,col) in enumerate([(-.017,'#596E80'),(.017,'#B77869')]):
 ...
 tube('motor wire'+str(j),[(x,.083,0),(x*1.25,.090,.008),(x*.8,.096,-.023),(x*.42,.093,-.023)],.001,col,n=6)
 ball('motor terminal'+str(j),(x*.42,.093,-.023),.0016,'#BAA88A')
