...
def ball(name,c,r,color):
 ...
 x,y,z=c;n=12;rings=7;v=[[x+r*math.cos(t)*math.cos(a),y+r*math.sin(t),z+r*math.cos(t)*math.sin(a)] for t in np.linspace(-math.pi/2,math.pi/2,rings) for a in np.linspace(0,2*math.pi,n,endpoint=False)]
...
for side in [-1,1]:
 panel('long folded boat side',[(-.36,.035,side*.18),(.36,.035,side*.18),(.39,.085,side*.22),(-.39,.085,side*.22)],'#E6D6B3')
 panel('boat end',[(side*.36,.035,-.18),(side*.36,.035,.18),(side*.39,.085,.22),(side*.39,.085,-.22)],'#B9A481')
r=.108
for x in [-.24,0,.24]:
 for z in [-.12,.12]:
