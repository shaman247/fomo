...
for col,faces in parts.items():mesh('groove' if col=='#D7B67C' else 'fabric',v,faces,col)
...
mesh('beak',[[-.026,.064,.025],[-.016,.064,.025],[-.021,.051,.027],[-.021,.060,.038]],[[0,2,1],[0,1,3],[1,2,3],[2,0,3]],'#E5AD5D')
...
S['measurements']=dict(body_height_m=.0897,maximum_body_width_m=.070,maximum_depth_m=.056,groove_depth_m=.0012,cloth_thickness_illustrative_m=.0005,spatula_handle_diameter_m=.0076)
