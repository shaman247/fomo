...
box('dyed sample',(.25,.34,-.07),(.48,.55,.016),'#6F95A2')
for x in [.10,.25,.40]:box('resist vertical band',(x,.34,-.059),(.036,.54,.006),'#E2E3CA')
for y in [.16,.34,.52]:box('resist horizontal band',(.25,y,-.055),(.47,.032,.006),'#E2E3CA')
...
# Rear inset uses the same shape at a smaller illustrative scale. Needle closes into C catch.
...
rod('pin stem',(-.23,0,.07),(.235,0,.07),.012,'#526E7B',12)
...
S['notes']=['Separate front and back views, not two overlapping parts of one physical pin. Felt carries original five-petal stitched decoration. Back inset hinge, stem and C catch are attached to a bar, with needle captured beneath the hook. C-catch geometry informed by jewelry maker structural account; workshop clasp type may vary. Hardware is enlarged relative to real brooch to remain visible.']
