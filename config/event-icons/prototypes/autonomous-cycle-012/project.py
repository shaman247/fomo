...
b=Path('.scratch/icon-cycles-20260909/cycle-012');out=b/'art'
...
def project(s):
 ...
 for p in s['parts']:
  ...
  for fidx in p['faces']:
   ...
   if p['name'] in ['left collage','collage mountain','collage sun','left text','right panel','right text']:factor=1
