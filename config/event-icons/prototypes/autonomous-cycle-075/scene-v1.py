...
for i,(x,z) in enumerate([(-.045,-.075),(0,-.075),(.045,-.075),(-.045,-.035),(.045,-.035),(-.045,.015),(.045,.015),(-.045,.065),(0,.065),(.045,.065)]):flatgem('border rhinestone',x,z,.006,['#F1C47D','#B67E9D'][i%2])
for i in range(5):
 a=2*math.pi*i/5;flatgem('rosette rhinestone',.018*math.cos(a),-.007+.018*math.sin(a),.006,'#F1C47D')
flatgem('center rhinestone',0,-.007,.0065,'#B67E9D')
