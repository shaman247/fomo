...
for side in [-1,1]:
 panel('pouch side gusset',[(side*.34,.07,-.09),(side*.30,.46,-.09),(side*.29,.37,.09),(side*.34,.07,.09)],'#8BA9A1')
...
for x in [-.43,.43]:
 extrude('stage side curtain',[(x-.048,.005),(x+.048,.005),(x+.064,.75),(x-.064,.75)],-.17,-.14,'#AA859D')
