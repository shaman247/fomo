...
art['preview-screening']=frame('#E4D3B4')+'<path d="M29 61Q62 23 99 61Q62 98 29 61Z" fill="#FEF5DC"/><circle cx="64" cy="61" r="16" fill="#7C9F96"/><path d="m60 50 16 11-16 11Z" fill="#45616B"/><path d="m83 84 8-7v5h9v5h-9v5Z" fill="#B67D6A"/>'
# Ringed planet is a conventional genre symbol,not a particular astrophysical scene.
art['science-fiction-film']=frame('#536D83')+'<circle cx="65" cy="62" r="22" fill="#E6C18B"/><path d="M80 46a22 22 0 0 1-29 31 22 22 0 0 0 29-31Z" fill="#CD9E76"/><ellipse cx="65" cy="62" rx="34" ry="9" transform="rotate(-25 65 62)" fill="none" stroke="#ACCCD0" stroke-width="6"/><path d="m36 36 2 5 5 2-5 2-2 5-2-5-5-2 5-2Z" fill="#EFE2BE"/><circle cx="91" cy="88" r="3" fill="#E9D9B6"/>'
