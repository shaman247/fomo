...
b=Path('.scratch/icon-cycles-20260909/cycle-010');out=b/'art'
...
def project(s):
 ...
 for p in s['parts']:
  ...
  for fidx in p['faces']:
   ...
   if p['name'] in ['wool fibers','water emblem','soap foam','net mesh','net rim','observed organism','organism tail','apple','apple leaf','visible cider','bamboo slat','mat binding','rib','nori roll','nori cut']:factor=1
