...
import scene as sc
from scene import *
def bubble(name,a,b,r,col,bend=(0,0,0),n=24,rings=19):
 ...
 faces=[tri for f in faces for tri in [[f[0],f[1],f[2]],[f[0],f[2],f[3]]]]
...
for side in [-1,1]:
 ...
 bubble('rear leg '+str(side),back,(.065,.01,0),.017,col,bend=(0,0,side*.02))
