...
b=Path('.scratch/icon-cycles-20260909/cycle-021');out=b/'art'
...
def project(s):
 ...
 result=''.join(body)
 if tuple(s['camera'])==tuple(SCENES[s['name']]['camera']):
  if s['name']=='studio-recording':
   result='<g transform="translate(-9 7) scale(.89)">'+result+'</g><circle cx="103" cy="30" r="12" fill="#CB6866"/><path d="M88 70V79M95 62V87M102 67V82M109 58V90M116 72V77" fill="none" stroke="#CB6866" stroke-width="4" stroke-linecap="round"/>'
  elif s['name']=='party-cruise':
   result='<g transform="translate(0 20)">'+result+'</g><g transform="translate(0 18)"><path d="M30 28V10L47 7V23" fill="none" stroke="#C47762" stroke-width="5" stroke-linejoin="round"/><ellipse cx="25" cy="29" rx="7" ry="5" fill="#C47762"/><ellipse cx="42" cy="24" rx="7" ry="5" fill="#C47762"/></g><path d="M15 111Q26 103 37 111T59 111T81 111T103 111T119 109" fill="none" stroke="#72AFB8" stroke-width="5" stroke-linecap="round"/>'
