...
b=Path('.scratch/icon-cycles-20260909/cycle-024');body='<style>body{font:15px sans-serif;background:#ddd}.row{display:flex}.cell{width:175px;background:white;margin:4px;text-align:center}.cell svg{width:160px;height:160px}</style>'
