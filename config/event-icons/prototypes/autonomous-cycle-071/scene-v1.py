...
for layer,(R,h,col) in enumerate([(.050,.014,'#D9928F'),(.038,.025,'#ECAA9A'),(.023,.034,'#E9BB80')]):
 ...
 mesh('ruffled tissue layer'+str(layer),v,f,col);S['parts'][-1]['double_sided']=True
...
mesh('folded tissue strip',v,f,'#E6B58B');S['parts'][-1]['double_sided']=True
