...
b=Path('.scratch/icon-cycles-20260909/cycle-011');out=b/'art'
...
def project(s):
 ...
 for p in s['parts']:
  ...
  for fidx in p['faces']:
   ...
   if p['name'] in ['paint sky','paint hills','tree canopy','path','caution triangle','caution mark','caution dot','trigger wire','sling webbing']:factor=1
