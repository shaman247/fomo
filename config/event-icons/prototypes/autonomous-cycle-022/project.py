...
b=Path('.scratch/icon-cycles-20260909/cycle-022');out=b/'art'
...
def project(s):
 ...
 for p in s['parts']:
  ...
  for fidx in p['faces']:
   ...
   if p['name'] in ['leaf vein','screen diamond','grille mark','tension rope','die edge','joining stitch']:factor=1
