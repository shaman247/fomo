...
extrude('arrow sign',[(-.34,.28),(.11,.28),(.11,.19),(.35,.40),(.11,.61),(.11,.52),(-.34,.52)],-.01,.065,'#639699')
for x in [-.24,-.13,-.02]:rod('inset bulb',(x,.40,.066),(x,.40,.075),.022,'#E9D9AA',16)
S['notes']=['Two original generic storefront signs attach to a freestanding display backing; backing contacts a broad foot. Raised OPEN lettering and arrow with three bulbs are illustrative, not a copied business or collection inventory. This denotes sign heritage, not a real navigation direction.']
...
for x,z,top in [(-.28,0,.83),(-.08,.04,.76),(-.20,-.06,.92)]:
 ...
 for side,y in [(-1,top-.10),(1,top-.22)]:
  panel('generic gathered leaf',[(x,y,z),(x+side*.14,y+.06,z+.025),(x+side*.13,y+.14,z),(x+side*.025,y+.11,z-.015)],'#90A376')
