...
b=Path('.scratch/icon-cycles-20260909/cycle-029');out=b/'art'
...
def project(s):
 ...
 for i,(poly,plane,color) in enumerate(faces):
  ...
  for j in tree.query(poly):
   ...
   if not cutter.is_empty:visible=visible.difference(cutter,grid_size=.000001)
