...
for xx in [-.035,.035]:oval('eye',(x+xx,1.497,z+.139),.010,[1,1,.3],'#514F65',True)
...
for c,r,sc,col in [((-.28,1.62,.01),.36,[1,1.1,.75],'#76A76D'),((.29,1.75,-.04),.37,[1,1.08,.80],'#689B6D'),((-.06,2.00,0),.38,[1,1,.8],'#80AF73')]:oval('leaf canopy',c,r,sc,col)
