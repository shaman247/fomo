...
$new_locations = [
    [
        ...
        'short_name' => 'Brick Church',
        'description' => 'Historic Presbyterian church on the Upper East Side, hosting concerts and community events since 1767.',
        'address' => '1140 Park Ave, New York, NY 10128, USA',
        'lat' => 40.7836727,
        'lng' => -73.9550981,
        'emoji' => '⛪',
        'tags' => ['Manhattan', 'Upper East Side', 'Carnegie Hill', 'Church'],
    ],
    [
        'name' => 'DGA New York Theater',
        'short_name' => 'DGA Theater',
        'description' => 'Premier 436-seat screening facility at the Directors Guild of America, used for film premieres, screenings, and special events.',
        'address' => '110 W 57th St, New York, NY 10019, USA',
        'lat' => 40.7645024,
        'lng' => -73.9781866,
        'emoji' => '🎬',
        'tags' => ['Manhattan', 'Midtown', 'Theater'],
    ],
    [
        'name' => 'East River Bar',
        'description' => 'Williamsburg dive bar with a large backyard, craft beer, and regular live music and DJ events.',
        'address' => '97 S 6th St, Brooklyn, NY 11211, USA',
        'lat' => 40.7109536,
        'lng' => -73.9646381,
        'emoji' => '🍺',
        'tags' => ['Brooklyn', 'Williamsburg', 'Bar'],
    ],
    [
        'name' => 'Stephen Wise Free Synagogue',
        'short_name' => 'Stephen Wise',
        'description' => 'Reform synagogue on the Upper West Side hosting worship services, concerts, and community events.',
        'address' => '30 W 68th St, New York, NY 10023, USA',
        'lat' => 40.7739911,
        'lng' => -73.9791692,
        'emoji' => '✡️',
        'tags' => ['Manhattan', 'Upper West Side', 'Church'],
    ],
    [
        'name' => 'POWRPLNT',
        'description' => 'Artist-run digital art space offering workshops in new media, creative coding, and interactive art.',
        'address' => '400 Jay St, Suite 101, Brooklyn, NY 11201, USA',
        'lat' => 40.6921618,
        'lng' => -73.9875941,
        'emoji' => '💻',
        'tags' => ['Brooklyn', 'Downtown Brooklyn', 'Gallery', 'Community Space'],
    ],
    [
        'name' => 'The Collapsable Hole',
        'short_name' => 'Collapsable Hole',
        'description' => 'Artist-run performance venue at Westbeth for cross-disciplinary experimental theater and performance art.',
        'address' => '155 Bank St, New York, NY 10014, USA',
        'lat' => 40.7362789,
        'lng' => -74.0091535,
        'emoji' => '🎭',
        'tags' => ['Manhattan', 'West Village', 'Performance Space'],
    ],
    [
        'name' => 'Equity Gallery',
        'description' => 'Gallery on the Lower East Side run by the New York Artists Equity Association, showing contemporary art.',
        'address' => '245 Broome St, New York, NY 10002, USA',
        'lat' => 40.7177730,
        'lng' => -73.9897680,
        'emoji' => '🎨',
        'tags' => ['Manhattan', 'Lower East Side', 'Gallery'],
    ],
    [
        'name' => 'Walkway Over the Hudson',
        'description' => "World's longest elevated pedestrian bridge spanning the Hudson River, offering scenic views and hosting public events.",
        'address' => '61 Parker Ave, Poughkeepsie, NY 12601, USA',
        'lat' => 41.7105282,
        'lng' => -73.9314276,
        'emoji' => '🌳',
    ...
    [
        ...
        'short_name' => 'Trailside Museums',
        'description' => 'Nature museums and small zoo within Bear Mountain State Park featuring native wildlife and guided hikes.',
        'address' => 'Bear Mountain State Park, Bear Mountain, NY 10911, USA',
        'lat' => 41.3177592,
        'lng' => -73.9894840,
        'emoji' => '🏛️',
        'tags' => ['Hudson Valley', 'Museum', 'Park'],
    ],
    [
        'name' => 'Kumble Theater at LIU Brooklyn',
        'short_name' => 'Kumble Theater',
        'description' => 'Performing arts theater on the LIU Brooklyn campus hosting concerts, film screenings, and community events.',
        'address' => '1 University Plaza, Brooklyn, NY 11201, USA',
        'lat' => 40.6912612,
        'lng' => -73.9812235,
        'emoji' => '🎭',
        'tags' => ['Brooklyn', 'Downtown Brooklyn', 'Theater'],
    ],
    [
        'name' => "Maggie's Little Theater",
        'description' => 'Community theater at St. Margaret Parish in Middle Village, Queens, producing musicals and plays since 2007.',
        'address' => '66-05 79th Pl, Middle Village, NY 11379, USA',
        'lat' => 40.7153444,
        'lng' => -73.8728482,
        'emoji' => '🎭',
        'tags' => ['Queens', 'Middle Village', 'Theater'],
    ],
    [
        'name' => 'Shu Swamp Nature Preserve',
        'short_name' => 'Shu Swamp',
        'description' => '60-acre wooded wetland preserve on Long Island with 2.5 miles of trails and boardwalks through the Beaver Brook system.',
        'address' => 'Frost Mill Rd, Mill Neck, NY 11765, USA',
        'lat' => 40.8798380,
        'lng' => -73.5635774,
        'emoji' => '🌳',
        'tags' => ['Long Island', 'Park'],
    ],
    [
        'name' => "O'Byrne Chapel at Manhattanville University",
        'short_name' => "O'Byrne Chapel",
        'description' => 'Chapel at Manhattanville University in Westchester used for choral and orchestral concerts.',
        'address' => '2900 Purchase St, Purchase, NY 10577, USA',
        'lat' => 41.0320144,
        'lng' => -73.7158605,
        'emoji' => '🎵',
        'tags' => ['Westchester', 'Venue'],
    ],
    [
        'name' => 'Kilo Bravo',
        'description' => 'Williamsburg neighborhood bar with games, craft cocktails, and regular social events.',
        'address' => '180 N 10th St, Brooklyn, NY 11211, USA',
        'lat' => 40.7189409,
        'lng' => -73.9554443,
        'emoji' => '🍺',
        'tags' => ['Brooklyn', 'Williamsburg', 'Bar'],
    ...
    [
        ...
        'short_name' => 'Conwell Coffee',
        'description' => "Art Deco coffee hall in a converted FiDi bank that hosts The Moth StorySLAMs and other evening performances.",
        'address' => '6 Hanover St, New York, NY 10005, USA',
        'lat' => 40.7054353,
        'lng' => -74.0091413,
        'emoji' => '☕',
        'tags' => ['Manhattan', 'Financial District', 'Venue'],
    ],
    [
        'name' => 'Boucherie West Village',
        'short_name' => 'Boucherie',
        'description' => 'French brasserie in the West Village serving classic bistro fare.',
        'address' => '99 7th Ave S, New York, NY 10014, USA',
        'lat' => 40.7330470,
        'lng' => -74.0028772,
        'emoji' => '🍽️',
        'tags' => ['Manhattan', 'West Village', 'Restaurant'],
    ],
    [
        'name' => 'Caravan of Dreams',
        'description' => 'Organic vegan restaurant in the East Village hosting live music, community events, and cultural gatherings.',
        'address' => '405 E 6th St, New York, NY 10009, USA',
        'lat' => 40.7263767,
        'lng' => -73.9856524,
        'emoji' => '🌿',
        'tags' => ['Manhattan', 'East Village', 'Restaurant', 'Venue'],
    ],
    [
        'name' => 'Prospect Butcher Co.',
        'short_name' => 'Prospect Butcher',
        'description' => 'Neighborhood butcher shop in Prospect Heights offering hands-on butchery classes and workshops.',
        'address' => '665 Vanderbilt Ave, Brooklyn, NY 11238, USA',
        'lat' => 40.6770125,
        'lng' => -73.9689099,
        'emoji' => '🥩',
        'tags' => ['Brooklyn', 'Prospect Heights', 'Venue'],
    ],
    [
        'name' => 'Make Manifest',
        'description' => 'Black-owned Bed-Stuy boutique and community space hosting wellness events, workshops, and cultural gatherings.',
        'address' => '382 Tompkins Ave, Brooklyn, NY 11216, USA',
        'lat' => 40.6841246,
        'lng' => -73.9443468,
        'emoji' => '🫱🏾‍🫲🏼',
        'tags' => ['Brooklyn', 'Bed-Stuy', 'Community Space'],
    ],
    [
        'name' => 'Da Spot NYC',
        'short_name' => 'Da Spot',
        'description' => 'Culture hub at City Point Brooklyn hosting comedy nights, community events, and creative pop-ups.',
        'address' => '445 Albee Square W, Brooklyn, NY 11201, USA',
        'lat' => 40.6911058,
        'lng' => -73.9831757,
        'emoji' => '🎤',
        'tags' => ['Brooklyn', 'Downtown Brooklyn', 'Venue'],
    ],
    [
        'name' => "Jake's Steakhouse (Bronx)",
        'short_name' => "Jake's Steakhouse",
        'description' => 'Classic Bronx steakhouse known for prime cuts and old-school dining atmosphere.',
        'address' => '6031 Broadway, Bronx, NY 10471, USA',
        'lat' => 40.8917049,
        'lng' => -73.8976496,
        'emoji' => '🥩',
        'tags' => ['Bronx', 'Restaurant'],
    ],
    [
        'name' => 'George F. Baker Jr. House',
        'short_name' => 'Baker House',
        'description' => 'Landmark Carnegie Hill mansion complex used for cultural events and lectures.',
        'address' => '67 E 93rd St, New York, NY 10128, USA',
        'lat' => 40.7850934,
        'lng' => -73.9545371,
        'emoji' => '🏛️',
        'tags' => ['Manhattan', 'Upper East Side', 'Carnegie Hill', 'Venue'],
    ],
    [
        'name' => 'Davidoff of Geneva (Midtown)',
        'short_name' => 'Davidoff of Geneva',
        'description' => 'Flagship Davidoff cigar store and lounge on 6th Avenue hosting tastings and special events.',
        'address' => '1390 6th Ave, New York, NY 10019, USA',
        'lat' => 40.7638191,
        'lng' => -73.9772048,
        'emoji' => '🏢',
        'tags' => ['Manhattan', 'Midtown', 'Venue'],
    ],
    [
        'name' => 'Homerun',
        'description' => 'Williamsburg streetwear and culture shop hosting community events, run clubs, and launch parties.',
        'address' => '366 Graham Ave, Brooklyn, NY 11211, USA',
        'lat' => 40.7153653,
        'lng' => -73.9443057,
        'emoji' => '👟',
        'tags' => ['Brooklyn', 'Williamsburg', 'Community Space'],
    ],
    [
        'name' => 'Seven House Gallery',
        'short_name' => 'Seven House',
        'description' => 'Independent art gallery in East Williamsburg hosting exhibitions, performances, and community events.',
        'address' => '35 Meadow St, Brooklyn, NY 11206, USA',
        'lat' => 40.7110655,
        'lng' => -73.9358610,
        'emoji' => '🎨',
        'tags' => ['Brooklyn', 'Bushwick', 'Gallery'],
    ],
    [
        'name' => 'Studio6 Gallery',
        'short_name' => 'Studio6',
        'description' => 'Contemporary art gallery in Bushwick hosting exhibitions, comedy shows, and creative events.',
        'address' => '56 Bogart St, Brooklyn, NY 11206, USA',
        'lat' => 40.7058299,
        'lng' => -73.9332504,
        'emoji' => '🎨',
        'tags' => ['Brooklyn', 'Bushwick', 'Gallery'],
...
$done_unmapped_event_venues = [
    [
        'name' => 'Cocoon Tribeca',
        'description' => 'Family-oriented social and learning club with classrooms, dance studio, art studio, parkour gym, and rock climbing in an 18,000 sq ft Tribeca space.',
        'address' => '316 Greenwich St, New York, NY 10013, USA',
        'lat' => 40.717949,
        'lng' => -74.010974,
        'emoji' => '🫱🏾‍🫲🏼',
        'tags' => ['Manhattan', 'Tribeca', 'Family', 'Community Space'],
    ],
    [
        'name' => 'White Noise Coffee Co.',
        'short_name' => 'White Noise Coffee',
        'description' => 'Coffee shop and roastery in Hell\'s Kitchen, also home to a community run club.',
        'address' => '829 11th Ave, Manhattan, NY 10019, USA',
        'lat' => 40.770147,
        'lng' => -73.991931,
        'emoji' => '☕',
        'tags' => ['Manhattan', "Hell's Kitchen"],
    ],
    [
        'name' => 'Dromedary',
        'description' => 'Queer community-focused tiki-dive bar in Bushwick hosting drag brunch, trivia, and DJ nights.',
        'address' => '266 Irving Ave, Brooklyn, NY 11237, USA',
        'lat' => 40.699640,
        'lng' => -73.915825,
        'emoji' => '🍹',
        'tags' => ['Brooklyn', 'Bushwick', 'Nightlife', 'LGBTQ'],
    ],
    [
        'name' => 'Hello Meadow BK',
        'description' => 'Industrial-chic event venue in East Williamsburg with exposed brick and large windows, hosting community events and private gatherings.',
        'address' => '20 Meadow St, Brooklyn, NY 11206, USA',
        'lat' => 40.710529,
        'lng' => -73.936397,
        'emoji' => '🎭',
        'tags' => ['Brooklyn', 'East Williamsburg', 'Events'],
    ],
    [
        'name' => 'PS9 Pets',
        'description' => 'Williamsburg pet supply store hosting adoption events and pet community gatherings for over 20 years.',
        'address' => '169 N 9th St, Brooklyn, NY 11211, USA',
        'lat' => 40.718708,
        'lng' => -73.955986,
        'emoji' => '🐾',
        'tags' => ['Brooklyn', 'Williamsburg', 'Community'],
    ],
    [
        'name' => 'Element Training Club',
        'description' => 'Williamsburg strength and conditioning gym offering team-based workouts combining strength, conditioning, and mobility.',
        'address' => '667 Grand St, Brooklyn, NY 11211, USA',
        'lat' => 40.711651,
        'lng' => -73.945878,
        'emoji' => '🏋️',
        'tags' => ['Brooklyn', 'Williamsburg', 'Wellness'],
    ],
    [
        'name' => 'Maidstone Club',
        'description' => 'Historic private golf and social club in East Hampton, hosting benefit events and community gatherings.',
        'address' => '50 Old Beach Ln, East Hampton, NY 11937, USA',
        'lat' => 40.951618,
        'lng' => -72.174592,
        'emoji' => '🏌️',
        'tags' => ['Long Island', 'East Hampton'],
    ],
    [
        'name' => 'Tennis Club of Hastings',
        'description' => 'Community tennis club in Hastings-on-Hudson hosting matches, social events, and trivia nights.',
        'address' => '100 River St, Hastings-On-Hudson, NY 10706, USA',
        'lat' => 40.996464,
        'lng' => -73.884746,
        'emoji' => '🎾',
        'tags' => ['Westchester', 'Hastings-on-Hudson'],
    ],
    [
        'name' => 'STAPLE',
        'description' => 'Streetwear and sneaker culture brand and retail store in SoHo.',
        'address' => '21 Mercer St, New York, NY 10013, USA',
        'lat' => 40.720812,
        'lng' => -74.002132,
        'emoji' => '👟',
        'tags' => ['Manhattan', 'SoHo'],
    ...
    [
        'name' => 'T-Mobile Signature Store',
        'description' => 'Flagship T-Mobile retail experience in Times Square hosting meet-and-greets and promotional events.',
        'address' => '1535 Broadway Ste 0161A, New York, NY 10036, USA',
        'lat' => 40.758666,
        'lng' => -73.985539,
        'emoji' => '🏢',
    ...
    [
        'name' => 'Little Chef Little Cafe',
        'description' => 'Cozy cafe in Long Island City hosting book clubs and community meetups.',
        'address' => '5-43 48th Ave, Long Island City, NY 11101, USA',
        'lat' => 40.744360,
        'lng' => -73.954377,
        'emoji' => '☕',
        'tags' => ['Queens', 'Long Island City'],
    ],
    [
        'name' => 'Whole Foods Market Tribeca',
        'short_name' => 'Whole Foods Tribeca',
        'description' => 'Whole Foods grocery store in Tribeca hosting community game nights and social events.',
    ...
    [
        'name' => 'The Yard',
        'description' => 'Coworking space in Midtown hosting social coworking sessions and networking events.',
    ...
    [
        ...
        'short_name' => 'Selfhelp',
        'description' => 'Nonprofit providing home care and senior services, hosting social events and programs for Holocaust survivors and older adults.',
        'address' => '520 8th Ave 5th floor, New York, NY 10018, USA',
        'lat' => 40.753599,
        'lng' => -73.991980,
        'emoji' => '🫱🏾‍🫲🏼',
        'tags' => ['Manhattan', 'Midtown', 'Community'],
    ],
    [
        'name' => 'Sunrise Theater Company',
        'short_name' => 'Sunrise Theatre',
        'description' => 'Community theater company in Lynbrook producing off-Broadway shows, children\'s theater, and student productions.',
        'address' => '34 Forest Ave, Lynbrook, NY 11563, USA',
        'lat' => 40.656046,
        'lng' => -73.669853,
        'emoji' => '🎭',
        'tags' => ['Long Island', 'Lynbrook', 'Theatre'],
    ],
];
...
$done_partiful_venues = [
    [
        'name' => '110 Studios',
        'description' => 'Bushwick creative space hosting live showcases, open mics, comedy, and community arts events.',
        'address' => '110 Troutman St, Brooklyn, NY 11206, USA',
        'lat' => 40.699326,
        'lng' => -73.929734,
        'emoji' => '🎭',
        'tags' => ['Brooklyn', 'Bushwick', 'Live Music', 'Art'],
    ],
    [
        'name' => 'Anaïs',
        'description' => 'Intimate wine bar and event space in Boerum Hill hosting themed parties and social gatherings.',
        'address' => '196 Bergen St, Brooklyn, NY 11217, USA',
        'lat' => 40.684855,
        'lng' => -73.986108,
        'emoji' => '🍷',
        'tags' => ['Brooklyn', 'Boerum Hill', 'Bar'],
    ],
    [
        'name' => 'Bakline HQ',
        'description' => 'Community running club headquarters in Gowanus hosting run meetups, book clubs, and social events.',
        'address' => '424a 3rd Ave, Brooklyn, NY 11215, USA',
        'lat' => 40.672879,
        'lng' => -73.990119,
        'emoji' => '🏃',
        'tags' => ['Brooklyn', 'Gowanus', 'Running', 'Community Space'],
    ],
    [
        'name' => 'Bedford Studio',
        'description' => 'West Village event and pop-up space hosting art shows, brand activations, and community gatherings.',
        'address' => '62 Bedford St, New York, NY 10014, USA',
        'lat' => 40.731118,
        'lng' => -74.004602,
        'emoji' => '🎨',
        'tags' => ['Manhattan', 'West Village', 'Art', 'Community Space'],
    ],
    [
        'name' => 'Blazers Sports Bar',
        'description' => 'Williamsburg sports bar hosting trivia nights, watch parties, and social events.',
        'address' => '308 Bedford Ave, Brooklyn, NY 11249, USA',
        'lat' => 40.713862,
        'lng' => -73.961905,
        'emoji' => '🍻',
        'tags' => ['Brooklyn', 'Williamsburg', 'Bar'],
    ...
    [
        'name' => 'Casanara',
        'description' => 'Clinton Hill bar and lounge hosting dance parties, DJ nights, and social events.',
        'address' => '983 Fulton St, Brooklyn, NY 11238, USA',
        'lat' => 40.683002,
        'lng' => -73.963543,
        'emoji' => '🪩',
        'tags' => ['Brooklyn', 'Clinton Hill', 'Bar', 'Dance'],
    ],
    [
        'name' => 'Color Me Mine',
        'description' => 'Paint-your-own pottery studio on the Upper West Side offering creative workshops and social painting events.',
        'address' => '177 Amsterdam Ave, New York, NY 10023, USA',
        'lat' => 40.776062,
        'lng' => -73.983250,
        'emoji' => '🎨',
    ...
    [
        'name' => 'Fresh Salt',
        'description' => 'Cozy bar in the South Street Seaport area hosting film screenings, social mixers, and themed nights.',
        'address' => '146 Beekman St, New York, NY 10038, USA',
        'lat' => 40.707086,
        'lng' => -74.002481,
        'emoji' => '🍹',
        'tags' => ['Manhattan', 'Financial District', 'Bar'],
    ],
    [
        'name' => 'Hifi Provisions',
        'description' => 'Audiophile listening lounge in Industry City hosting album listening sessions and music events on high-end sound systems.',
        'address' => '51 35th St, Brooklyn, NY 11232, USA',
        'lat' => 40.657134,
        'lng' => -74.007193,
        'emoji' => '🎧',
        'tags' => ['Brooklyn', 'Sunset Park', 'Music'],
    ],
    [
        'name' => "Honey's Brooklyn",
        'description' => 'East Williamsburg bar and event space hosting live music, DJ sets, and community gatherings.',
        'address' => '93 Scott Ave, Brooklyn, NY 11237, USA',
        'lat' => 40.710449,
        'lng' => -73.923158,
        'emoji' => '🍹',
        'tags' => ['Brooklyn', 'East Williamsburg', 'Bar', 'Live Music'],
    ],
    [
        'name' => 'Ki Smith Gallery',
        'description' => 'Lower East Side contemporary art gallery hosting exhibitions, performances, and live music events.',
        'address' => '170 Forsyth St, New York, NY 10002, USA',
        'lat' => 40.721210,
        'lng' => -73.991207,
        'emoji' => '🎨',
    ...
    [
        'name' => 'Knockout Cafe',
        'description' => 'East Village coffee shop hosting art showcases, collage workshops, and creative community events.',
        'address' => '530 E 13th St, New York, NY 10009, USA',
        'lat' => 40.729050,
        'lng' => -73.979513,
        'emoji' => '☕',
        'tags' => ['Manhattan', 'East Village', 'Cafe', 'Art'],
    ],
    [
        'name' => 'Lips Cafe',
        'description' => 'Flatbush cafe and event space hosting art exhibitions, live music, and cultural community events.',
        'address' => '1412 Nostrand Ave, Brooklyn, NY 11226, USA',
        'lat' => 40.651915,
        'lng' => -73.949874,
        'emoji' => '☕',
        'tags' => ['Brooklyn', 'Flatbush', 'Cafe', 'Art'],
    ],
    [
        'name' => "Lou's Athletic Club",
        'description' => 'Bushwick bar hosting watch parties, live events, and neighborhood social gatherings.',
        'address' => '384 Knickerbocker Ave, Brooklyn, NY 11237, USA',
        'lat' => 40.700212,
        'lng' => -73.921079,
        'emoji' => '🍹',
    ...
    [
        ...
        'description' => 'Crown Heights brewery and bar hosting community events, cultural celebrations, and live entertainment.',
        'address' => '1207 Nostrand Ave, Brooklyn, NY 11225, USA',
        'lat' => 40.657739,
        'lng' => -73.950057,
        'emoji' => '🍺',
        'tags' => ['Brooklyn', 'Crown Heights', 'Brewery', 'Bar'],
    ],
    [
        'name' => "Miss Barb's",
        'description' => 'Crown Heights bar and music venue hosting DJ nights, record swaps, and neighborhood social events.',
        'address' => '1038 Nostrand Ave, Brooklyn, NY 11225, USA',
        'lat' => 40.662919,
        'lng' => -73.951076,
        'emoji' => '🍹',
        'tags' => ['Brooklyn', 'Crown Heights', 'Bar', 'Music'],
    ],
    [
        'name' => 'Moshava Art',
        'description' => 'Greenwich Village art and event space hosting film screenings, creative workshops, and cultural gatherings.',
        'address' => '45 W 8th St, New York, NY 10011, USA',
        'lat' => 40.733310,
        'lng' => -73.998425,
        'emoji' => '🎨',
        'tags' => ['Manhattan', 'Greenwich Village', 'Art'],
    ],
    [
        'name' => "Paul's Casablanca",
        'description' => 'Hudson Square cocktail bar and party venue known for lively DJ nights and celebratory events.',
        'address' => '305 Spring St, New York, NY 10013, USA',
        'lat' => 40.726154,
        'lng' => -74.008360,
        'emoji' => '🪩',
        'tags' => ['Manhattan', 'Hudson Square', 'Bar', 'Dance'],
    ],
    [
        'name' => 'Revision Lounge & Gallery',
        'description' => 'East Village art gallery and lounge hosting comedy shows, art openings, and social events.',
        'address' => '219 Avenue B, New York, NY 10009, USA',
        'lat' => 40.728922,
        'lng' => -73.978271,
        'emoji' => '🎨',
        'tags' => ['Manhattan', 'East Village', 'Art', 'Comedy'],
    ],
    [
        'name' => 'Ripley-Grier Studios',
        'description' => 'Major Midtown rehearsal studio complex hosting dance workshops, auditions, and performing arts events.',
        'address' => '520 8th Ave, New York, NY 10018, USA',
        'lat' => 40.753742,
        'lng' => -73.992118,
        'emoji' => '💃',
        'tags' => ['Manhattan', 'Midtown', 'Dance', 'Theatre'],
    ],
    [
        'name' => 'Rough Draft',
        'description' => 'Hamilton Heights bar and creative space hosting open mics, cultural showcases, and community events.',
        'address' => '126 Hamilton Pl, New York, NY 10031, USA',
        'lat' => 40.824015,
        'lng' => -73.949394,
        'emoji' => '🍹',
        'tags' => ['Manhattan', 'Hamilton Heights', 'Bar', 'Live Music'],
    ],
    [
        'name' => "Somebody's Darling",
        'description' => 'Upper East Side wine bar and craft cocktail spot hosting embroidery workshops and creative social events.',
        'address' => '1664 1st Ave, New York, NY 10028, USA',
        'lat' => 40.777354,
        'lng' => -73.948821,
        'emoji' => '🍷',
        'tags' => ['Manhattan', 'Upper East Side', 'Bar', 'Workshop'],
    ],
    [
        'name' => 'Sparsa',
        'description' => 'Greenpoint cafe and wellness space hosting yoga sessions, charcuterie events, and community gatherings.',
        'address' => '1006 Manhattan Ave, Brooklyn, NY 11222, USA',
        'lat' => 40.733389,
        'lng' => -73.954472,
        'emoji' => '☕',
        'tags' => ['Brooklyn', 'Greenpoint', 'Cafe', 'Wellness'],
    ],
    [
        'name' => 'Studio 1514',
        'description' => 'Crown Heights creative studio hosting artist salons, exhibitions, and collaborative arts events.',
        'address' => '1193 Atlantic Ave, Brooklyn, NY 11216, USA',
        'lat' => 40.678861,
        'lng' => -73.951493,
        'emoji' => '🎨',
        'tags' => ['Brooklyn', 'Crown Heights', 'Art', 'Community Space'],
    ],
    [
        'name' => 'Time Again Bar',
        'description' => 'Chinatown bar hosting live music, DJ sets, and late-night social events.',
        'address' => '105 Canal St, New York, NY 10002, USA',
        'lat' => 40.715728,
        'lng' => -73.994050,
        'emoji' => '🍹',
        'tags' => ['Manhattan', 'Chinatown', 'Bar', 'Live Music'],
    ],
    [
        'name' => 'Unveiled',
        'description' => 'Williamsburg event space hosting release parties, DJ nights, and creative pop-up events.',
        'address' => '94 N 13th St, Brooklyn, NY 11249, USA',
        'lat' => 40.722570,
        'lng' => -73.956657,
        'emoji' => '🪩',
        'tags' => ['Brooklyn', 'Williamsburg', 'Dance', 'Events'],
    ],
    [
        'name' => 'Village Loft',
        'description' => 'Greenwich Village loft event space hosting pop-up shops, tastings, and community gatherings.',
        'address' => '10 E 8th St, New York, NY 10003, USA',
        'lat' => 40.731762,
        'lng' => -73.995748,
        'emoji' => '🏢',
        'tags' => ['Manhattan', 'Greenwich Village', 'Events'],
    ],
];

$done_ny_state_parks = [
    [
        'name' => 'Caleb Smith State Park Preserve',
        'description' => 'Nature preserve on Long Island offering hiking trails, fishing, and nature education programs in a former estate setting.',
        'address' => '581 W Jericho Turnpike, Smithtown, NY 11787, USA',
        'lat' => 40.851844,
        'lng' => -73.224833,
        'emoji' => '🌳',
        'tags' => ['Long Island', 'Smithtown', 'State Park', 'Nature'],
    ],
    [
        'name' => 'Caumsett State Historic Park Preserve',
        'description' => 'Historic estate-turned-park on Lloyd Neck featuring miles of trails, gardens, and waterfront views along Long Island Sound.',
        'address' => '25 Lloyd Harbor Rd, Lloyd Harbor, NY 11743, USA',
        'lat' => 40.930989,
        'lng' => -73.473288,
        'emoji' => '🌳',
        'tags' => ['Long Island', 'Lloyd Harbor', 'State Park', 'Nature'],
    ],
    [
        'name' => 'Clermont State Historic Site',
        'description' => 'Historic Hudson Valley estate of the Livingston family offering tours, cultural events, and scenic views of the Catskill Mountains.',
        'address' => '1 Clermont Ave, Germantown, NY 12526, USA',
        'lat' => 42.085929,
        'lng' => -73.919169,
        'emoji' => '🏛️',
        'tags' => ['Hudson Valley', 'Germantown', 'State Park', 'Historic Site'],
    ],
    [
        'name' => 'Crailo State Historic Site',
        'description' => 'Dutch colonial-era house museum in Rensselaer exploring the history of Dutch settlement in the Hudson Valley.',
        'address' => '9 1/2 Riverside Ave, Rensselaer, NY 12144, USA',
        'lat' => 42.634587,
        'lng' => -73.749319,
        'emoji' => '🏛️',
        'tags' => ['Capital District', 'Rensselaer', 'State Park', 'Historic Site'],
    ],
    [
        'name' => 'Green Lakes State Park',
        'description' => 'Central New York state park featuring two glacial lakes with striking turquoise water, swimming beach, golf course, and miles of trails.',
        'address' => '7900 Green Lakes Rd, Fayetteville, NY 13066, USA',
        'lat' => 43.058231,
        'lng' => -75.971452,
        'emoji' => '🌳',
        'tags' => ['Central New York', 'Fayetteville', 'State Park', 'Nature'],
    ],
    [
        'name' => 'Hallock State Park Preserve',
        'description' => 'North Fork nature preserve with hiking trails, beach access to Long Island Sound, and environmental education programs.',
        'address' => '6062 Sound Ave, Jamesport, NY 11947, USA',
        'lat' => 40.983443,
        'lng' => -72.588862,
        'emoji' => '🌳',
        'tags' => ['Long Island', 'North Fork', 'State Park', 'Nature'],
    ],
    [
        'name' => 'John Brown Farm State Historic Site',
        'description' => 'Historic homestead and gravesite of abolitionist John Brown in the Adirondacks, offering tours, hiking, and educational programs.',
        'address' => '115 John Brown Rd, Lake Placid, NY 12946, USA',
        'lat' => 44.249641,
        'lng' => -73.971503,
        'emoji' => '🏛️',
        'tags' => ['Adirondacks', 'Lake Placid', 'State Park', 'Historic Site'],
    ],
    [
        'name' => 'Lake Taghkanic State Park',
        'description' => 'Hudson Valley state park with a lake beach, campgrounds, hiking trails, and seasonal programs including star parties.',
        'address' => '1528 NY-82, Ancram, NY 12502, USA',
        'lat' => 42.090899,
        'lng' => -73.718261,
        'emoji' => '🌳',
        'tags' => ['Hudson Valley', 'Ancram', 'State Park', 'Nature'],
    ],
    [
        'name' => 'Niagara Falls State Park',
        'description' => 'America\'s oldest state park, offering views of Niagara Falls, trails, nature programs, and seasonal educational events.',
        'address' => '332 Prospect St, Niagara Falls, NY 14303, USA',
        'lat' => 43.086295,
        'lng' => -79.066425,
        'emoji' => '🌳',
        'tags' => ['Western New York', 'Niagara Falls', 'State Park', 'Nature'],
    ],
    [
        'name' => 'Old Croton Aqueduct State Historic Park',
        'description' => 'Linear trail park following the route of the historic 1842 aqueduct from Croton Dam to Yonkers, with guided hikes and history programs.',
        'address' => 'Old Croton Aqueduct Trail, Croton-On-Hudson, NY 10520, USA',
        'lat' => 41.208428,
        'lng' => -73.891248,
        'emoji' => '🌳',
        'tags' => ['Westchester', 'Croton-on-Hudson', 'State Park', 'Historic Site'],
    ],
    [
        'name' => 'Peebles Island State Park',
        'description' => 'Island park at the confluence of the Mohawk and Hudson Rivers offering hiking trails, picnicking, and nature programs.',
        'address' => 'Delaware Ave, Cohoes, NY 12047, USA',
        'lat' => 42.781875,
        'lng' => -73.685369,
        'emoji' => '🌳',
        'tags' => ['Capital District', 'Cohoes', 'State Park', 'Nature'],
    ],
    [
        'name' => 'Point Au Roche State Park',
        'description' => 'North Country park on Lake Champlain featuring nature trails, a beach, environmental education center, and seasonal outdoor programs.',
        'address' => '19 Camp Red Cloud Rd, Plattsburgh, NY 12901, USA',
        'lat' => 44.785513,
        'lng' => -73.380506,
        'emoji' => '🌳',
        'tags' => ['North Country', 'Plattsburgh', 'State Park', 'Nature'],
    ],
    [
        'name' => 'Saratoga Spa State Park',
        'description' => 'Historic park in Saratoga Springs with mineral springs, performing arts center, golf courses, pools, and the Spa City Farmers\' Market.',
        'address' => '19 Roosevelt Dr, Saratoga Springs, NY 12866, USA',
        'lat' => 43.054942,
        'lng' => -73.798059,
        'emoji' => '🌳',
        'tags' => ['Capital District', 'Saratoga Springs', 'State Park', 'Nature'],
    ],
    [
        'name' => 'Schoharie Crossing State Historic Site',
        'description' => 'Erie Canal heritage site in the Mohawk Valley preserving canal-era structures, with guided tours, museum exhibits, and educational programs.',
        'address' => '129 Schoharie St, Fort Hunter, NY 12069, USA',
        'lat' => 42.939452,
        'lng' => -74.282072,
        'emoji' => '🏛️',
        'tags' => ['Mohawk Valley', 'Fort Hunter', 'State Park', 'Historic Site'],
    ],
];
...
$done_org_venues = [
    [
        'name' => 'Harlem Parish',
        'description' => 'Arts and performance space in a historic Harlem church building hosting theater, opera, music, and community events.',
        'address' => '258 W 118th St, New York, NY 10026, USA',
        'lat' => 40.805111,
        'lng' => -73.953146,
        'emoji' => '🎭',
        'tags' => ['Manhattan', 'Harlem', 'Theatre'],
    ],
    [
        'name' => 'The Forum at Columbia University',
        'description' => 'Event and performance space at Columbia University\'s Manhattanville campus, hosting concerts, community events, and educational programs.',
        'address' => '601 W 125th St, New York, NY 10027, USA',
        'lat' => 40.816253,
        'lng' => -73.958389,
        'emoji' => '🎓',
        'tags' => ['Manhattan', 'Morningside Heights', 'Education'],
    ],
    [
        'name' => 'Playhouse 46 at St. Luke\'s',
        'description' => 'Intimate Off-Broadway theater space within St. Luke\'s Church in the Theater District, presenting plays, musicals, and solo shows.',
        'address' => '308 W 46th St, New York, NY 10036, USA',
        'lat' => 40.760007,
        'lng' => -73.988691,
        'emoji' => '🎭',
        'tags' => ['Manhattan', "Hell's Kitchen", 'Theatre'],
    ],
    [
        'name' => 'Cordelia',
        'description' => 'Wine bar and intimate performance venue in Crown Heights, Brooklyn, hosting Groupmuse classical and indie music concerts.',
        'address' => '942 Bergen St, Brooklyn, NY 11238, USA',
        'lat' => 40.676686,
        'lng' => -73.955998,
        'emoji' => '🍹',
        'tags' => ['Brooklyn', 'Crown Heights', 'Live Music'],
    ],
    [
        'name' => 'Church of St. Vincent Ferrer',
        'description' => 'Gothic Revival church on the Upper East Side hosting classical music concerts, including American Classical Orchestra performances.',
        'address' => '869 Lexington Ave, New York, NY 10065, USA',
        'lat' => 40.766361,
        'lng' => -73.964852,
        'emoji' => '⛪',
        'tags' => ['Manhattan', 'Upper East Side', 'Live Music'],
    ],
];

$done_parade_routes = [
    [
        'name' => '8th Avenue, Sunset Park',
        'description' => 'Section of 8th Avenue in Sunset Park, Brooklyn, the heart of Brooklyn\'s Chinatown and a major route for Lunar New Year parades and cultural celebrations.',
        'address' => '8th Ave & 50th St, Brooklyn, NY 11220, USA',
        'lat' => 40.641122,
        'lng' => -74.003714,
        'emoji' => '📍',
    ...
    [
        'name' => '86th Street, Bensonhurst',
        'description' => 'Section of 86th Street in Bensonhurst, Brooklyn, a major commercial corridor and route for Lunar New Year lion dance parades.',
        'address' => '20th Ave & 86th St, Brooklyn, NY 11214, USA',
        'lat' => 40.604610,
        'lng' => -73.998269,
        'emoji' => '📍',
        'tags' => ['Brooklyn', 'Bensonhurst'],
    ],
    [
        'name' => '61st Street, Sunset Park',
        'description' => 'Section of 61st Street near 8th Avenue in Sunset Park, Brooklyn, used for Lunar New Year lantern festivals and community celebrations.',
        'address' => '8th Ave & 61st St, Brooklyn, NY 11220, USA',
        'lat' => 40.634922,
        'lng' => -74.010163,
        'emoji' => '📍',
        'tags' => ['Brooklyn', 'Sunset Park'],
    ...
    [
        'name' => 'Avenue Z, Sheepshead Bay',
        'description' => 'Section of Avenue Z near Nostrand Avenue in Sheepshead Bay, Brooklyn, used for community parades and youth baseball celebrations.',
        'address' => 'Avenue Z & Batchelder St, Brooklyn, NY 11235, USA',
        'lat' => 40.589867,
        'lng' => -73.936984,
        'emoji' => '📍',
    ...
    [
        'name' => 'Park Avenue, Murray Hill',
        'description' => 'Section of Park Avenue and East 38th Street in Murray Hill, Manhattan, a route for the Sikh Day Parade and other cultural processions.',
        'address' => 'Park Ave & E 38th St, New York, NY 10016, USA',
        'lat' => 40.749567,
        'lng' => -73.979433,
        'emoji' => '📍',
    ...
    [
        'name' => 'Madison Avenue, Midtown',
        'description' => 'Section of Madison Avenue from East 27th to 38th Street in Midtown Manhattan, a route for the Turkish Day Parade and other cultural celebrations.',
        'address' => 'Madison Ave & E 33rd St, New York, NY 10016, USA',
        'lat' => 40.747106,
        'lng' => -73.983448,
        'emoji' => '📍',
        'tags' => ['Manhattan', 'Midtown'],
    ...
    [
        ...
        'description' => 'Section of Lafayette Street between Reade and Duane Streets in Tribeca, Manhattan, used for marches and public gatherings.',
        'address' => 'Lafayette St & Reade St, New York, NY 10007, USA',
        'lat' => 40.713672,
        'lng' => -74.003667,
        'emoji' => '📍',
        'tags' => ['Manhattan', 'Tribeca'],
    ...
    [
        'name' => 'Jerome Avenue, Woodlawn',
        'description' => 'Section of Jerome Avenue near Van Cortlandt Avenue and East 233rd Street in the Woodlawn section of the Bronx, used for community runs and parades.',
        'address' => 'Jerome Ave & E 233rd St, Bronx, NY 10470, USA',
        'lat' => 40.895255,
        'lng' => -73.880025,
        'emoji' => '📍',
        'tags' => ['Bronx', 'Woodlawn'],
    ...
    [
        'name' => 'Lafayette Avenue, Throgs Neck',
        'description' => 'Section of Lafayette Avenue near East Tremont Avenue in Throgs Neck, Bronx, used for the Bronx St. Patrick\'s Day Parade.',
        'address' => 'Lafayette Ave & E Tremont Ave, Bronx, NY 10465, USA',
        'lat' => 40.829698,
        'lng' => -73.825295,
        'emoji' => '📍',
    ...
    [
        'name' => '150th Street, Jamaica',
        'description' => 'Section of 150th Street near 88th Avenue in Jamaica, Queens, used for community religious processions and cultural gatherings.',
        'address' => '150th St & 88th Ave, Queens, NY 11432, USA',
        'lat' => 40.705699,
        'lng' => -73.806139,
        'emoji' => '📍',
        'tags' => ['Queens', 'Jamaica'],
    ...
    [
        'name' => 'Prince Street, Flushing',
        'description' => 'Section of 38th Avenue near Prince Street in downtown Flushing, Queens, used for rallies, parades, and cultural demonstrations.',
        'address' => 'Prince St & 38th Ave, Queens, NY 11354, USA',
        'lat' => 40.760175,
        'lng' => -73.832613,
        'emoji' => '📍',
        'tags' => ['Queens', 'Flushing'],
    ],
    [
        'name' => 'Newport Avenue, Rockaway',
        'description' => 'Section of Newport Avenue in the Rockaways, Queens, route for the Queens County St. Patrick\'s Day Parade along the waterfront.',
        'address' => 'B 132 St & Newport Ave, Queens, NY 11694, USA',
        'lat' => 40.576992,
        'lng' => -73.851554,
        'emoji' => '📍',
    ...
    [
        ...
        'description' => 'Section of Forest Avenue near Hart Boulevard in West Brighton, Staten Island, route for the Richmond County St. Patrick\'s Day Parade.',
        'address' => 'Hart Blvd & Forest Ave, Staten Island, NY 10301, USA',
        'lat' => 40.631215,
        'lng' => -74.100576,
        'emoji' => '📍',
    ...
    [
        'name' => 'Mason Avenue, South Beach',
        'description' => 'Section of Mason Avenue near Seaview Avenue in South Beach, Staten Island, used for community health walks and fundraising events.',
        'address' => 'Mason Ave & Seaview Ave, Staten Island, NY 10305, USA',
        'lat' => 40.584820,
        'lng' => -74.088455,
        'emoji' => '📍',
        'tags' => ['Staten Island', 'South Beach'],
    ],
    // Specific NYC addresses for community events
    [
        'name' => 'NeON Center Jamaica',
        'description' => 'Neighborhood Opportunity Network center in Jamaica, Queens, providing community services, benefits assistance, and social programs.',
        'address' => '162-24 Jamaica Ave, Jamaica, NY 11432, USA',
        'lat' => 40.704313,
        'lng' => -73.796976,
        'emoji' => '🫱🏾‍🫲🏼',
        'tags' => ['Queens', 'Jamaica', 'Community Space'],
    ],
    [
        'name' => 'Children of Promise NYC',
        'description' => 'Bronx-based nonprofit providing mentoring, after-school programs, and family support services for children affected by parental incarceration.',
        'address' => '1842 Webster Ave, Bronx, NY 10457, USA',
        'lat' => 40.846550,
        'lng' => -73.901168,
        'emoji' => '🫱🏾‍🫲🏼',
        'tags' => ['Bronx', 'Tremont', 'Community Space'],
    ],
    [
        'name' => 'Riverdale Y',
        'short_name' => 'Riverdale Y',
        'description' => 'Community center and fitness facility in Riverdale, Bronx, hosting sports events, family programs, and the annual Riverdale Y 5K Fun Run.',
        'address' => '5625 Arlington Ave, Bronx, NY 10471, USA',
        'lat' => 40.905141,
        'lng' => -73.908331,
        'emoji' => '🏊',
        'tags' => ['Bronx', 'Riverdale', 'Community Space'],
    ],
];

$done_orphan_fixes_round2 = [
    [
        'name' => 'Maretta',
        'description' => 'Italian restaurant and event space in the East Village, hosting social gatherings, pop-ups, and cultural celebrations.',
        'address' => '27 Avenue B, New York, NY 10009, USA',
        'lat' => 40.722254,
        'lng' => -73.982951,
        'emoji' => '🍝',
    ...
    [
        ...
        'description' => 'Contemporary art exhibition space in DUMBO showcasing emerging and established artists through curated shows and installations.',
        'address' => '20 Jay St, Suite 319, Brooklyn, NY 11201, USA',
        'lat' => 40.704079,
        'lng' => -73.987028,
        'emoji' => '🎨',
        'tags' => ['Brooklyn', 'DUMBO', 'Art'],
    ...
    [
        ...
        'description' => 'Community auditorium at the Church of the Good Shepherd in Inwood, hosting cultural events, concerts, and neighborhood gatherings.',
        'address' => '620 Isham St, New York, NY 10034, USA',
        'lat' => 40.869211,
        'lng' => -73.920758,
        'emoji' => '⛪',
        'tags' => ['Manhattan', 'Inwood', 'Community Space'],
    ],
    [
        'name' => 'New Dramatists',
        'description' => "The nation's oldest playwright development organization, providing time, space, and resources for emerging playwrights in Hell's Kitchen.",
        'address' => '424 W 44th St, New York, NY 10036, USA',
        'lat' => 40.760110,
        'lng' => -73.992909,
        'emoji' => '🎭',
        'tags' => ['Manhattan', "Hell's Kitchen", 'Theatre'],
    ...
    [
        ...
        'short_name' => 'CPC',
        'description' => "The nation's largest Asian American social services agency, hosting community events, cultural celebrations, and educational programs from its Chinatown headquarters.",
        'address' => '150 Elizabeth St, New York, NY 10012, USA',
        'lat' => 40.720314,
        'lng' => -73.995006,
        'emoji' => '🫱🏾‍🫲🏼',
        'tags' => ['Manhattan', 'Chinatown', 'Community Space'],
    ],
    [
        'name' => 'Yarn/Wire Studio',
        'description' => 'Studio home of contemporary music ensemble Yarn/Wire in Ridgewood, hosting intimate "Live from Troutman" concerts and performances.',
        'address' => '17-17 Troutman St, Suite 214, Ridgewood, NY 11385, USA',
        'lat' => 40.709323,
        'lng' => -73.920228,
        'emoji' => '🎤',
        'tags' => ['Queens', 'Ridgewood', 'Live Music'],
    ],
    [
        'name' => 'One Breath Rising',
        'description' => 'Brooklyn nonprofit presenting monthly spoken word and music events in Bed-Stuy, inspired by African American traditions of improvisation and storytelling.',
        'address' => '540 Hancock St, Brooklyn, NY 11233, USA',
        'lat' => 40.684239,
        'lng' => -73.933662,
        'emoji' => '📚',
        'tags' => ['Brooklyn', 'Bed-Stuy', 'Books'],
    ],
    [
        'name' => 'Montauk Atkins Community Garden',
        'description' => 'NYC Parks GreenThumb community garden in East New York focusing on community engagement, gardening, and environmental conservation.',
        'address' => '213 Atkins Ave, Brooklyn, NY 11208, USA',
        'lat' => 40.673881,
        'lng' => -73.878488,
        'emoji' => '🌱',
    ...
    [
        'name' => 'West 132nd Street Community Garden',
        'description' => 'English-style community garden in Central Harlem with flowerbeds, a central lawn, indigo plants, and a fishpond.',
        'address' => '108 W 132nd St, New York, NY 10027, USA',
        'lat' => 40.812353,
        'lng' => -73.943130,
        'emoji' => '🌱',
        'tags' => ['Manhattan', 'Harlem', 'Garden'],
    ],
    [
        'name' => 'The American Opera Project',
        'short_name' => 'AOP',
        'description' => 'Brooklyn-based opera company in Fort Greene dedicated to commissioning, developing, and presenting new American opera and music-theater.',
        'address' => '138 S Oxford St, Brooklyn, NY 11217, USA',
        'lat' => 40.685126,
        'lng' => -73.973522,
        'emoji' => '🎭',
        'tags' => ['Brooklyn', 'Fort Greene', 'Opera'],
    ],
    [
        'name' => 'PENN 1',
        'short_name' => 'PENN 1',
        'description' => 'Major office tower adjacent to Penn Station and Madison Square Garden in Midtown, hosting corporate events and galas.',
        'address' => '1 Penn Plaza, New York, NY 10119, USA',
        'lat' => 40.751087,
        'lng' => -73.992243,
        'emoji' => '🏢',
        'tags' => ['Manhattan', 'Midtown'],
...
$done_orphan_fixes = [
    [
        ...
        'description' => 'Irish pub in Midtown Manhattan hosting live music, comedy nights, and social events.',
        'address' => '8 E 36th St, New York, NY 10016, USA',
        'lat' => 40.749201,
        'lng' => -73.983038,
        'emoji' => '🍺',
        'tags' => ['Manhattan', 'Midtown', 'Bar'],
    ],
    [
        'name' => 'Ugly Duckling Presse',
        'description' => 'Independent nonprofit publisher in Gowanus hosting readings, book launches, and literary events at the Old American Can Factory.',
        'address' => '232 3rd St #E303, Brooklyn, NY 11215, USA',
        'lat' => 40.674751,
        'lng' => -73.987844,
        'emoji' => '📚',
        'tags' => ['Brooklyn', 'Gowanus', 'Books'],
    ],
    [
        'name' => 'One Story',
        'description' => 'Literary magazine and writing center hosting fiction workshops, readings, and craft talks at the Old American Can Factory.',
        'address' => '232 3rd St #A108, Brooklyn, NY 11215, USA',
        'lat' => 40.674751,
        'lng' => -73.987844,
        'emoji' => '📚',
        'tags' => ['Brooklyn', 'Gowanus', 'Books'],
    ...
    [
        'name' => 'Sō Percussion Studio',
        'description' => 'Studio space for the Grammy-winning percussion quartet, hosting concerts, workshops, and collaborative performances.',
        'address' => '20 Grand Ave #205, Brooklyn, NY 11205, USA',
        'lat' => 40.697037,
        'lng' => -73.964947,
        'emoji' => '🥁',
        'tags' => ['Brooklyn', 'Clinton Hill', 'Live Music'],
    ],
    [
        'name' => 'PS 230',
        'short_name' => 'PS 230',
        'description' => 'Brooklyn public school hosting community arts classes including salsa, singing, and traditional dance through Downtown Brooklyn Arts Alliance.',
        'address' => '1 Albemarle Rd, Brooklyn, NY 11218, USA',
        'lat' => 40.645318,
        'lng' => -73.980292,
        'emoji' => '🏫',
        'tags' => ['Brooklyn', 'Kensington', 'Education', 'Community Space'],
    ],
    [
        'name' => 'Raynham Hall Museum',
        'description' => 'Historic house museum in Oyster Bay, former home of Revolutionary War spy Robert Townsend, with tours, lectures, and seasonal events.',
        'address' => '20 W Main St, Oyster Bay, NY 11771, USA',
        'lat' => 40.872354,
        'lng' => -73.531927,
        'emoji' => '🏛️',
        'tags' => ['Long Island', 'Museum'],
    ],
    [
        'name' => 'Valley Cottage Library',
        'description' => 'Public library in Rockland County hosting concerts, lectures, and community events.',
        'address' => '110 NY-303, Valley Cottage, NY 10989, USA',
        'lat' => 41.116040,
        'lng' => -73.941408,
        'emoji' => '📖',
        'tags' => ['Rockland County', 'Library'],
    ],
    [
        'name' => 'A Public Space',
        'description' => 'Independent literary magazine and bookshop in Boerum Hill hosting readings, workshops, and literary events.',
        'address' => '323 Dean St, Brooklyn, NY 11217, USA',
        'lat' => 40.684027,
        'lng' => -73.980940,
        'emoji' => '📚',
        'tags' => ['Brooklyn', 'Boerum Hill', 'Books'],
    ],
    [
        'name' => 'Tangram Mall',
        'short_name' => 'Tangram',
        'description' => 'Mixed-use development in Flushing with retail, dining, and cultural event space hosting community festivals and performances.',
        'address' => '133-33 39th Ave, Flushing, NY 11354, USA',
        'lat' => 40.760062,
        'lng' => -73.833754,
        'emoji' => '🛍️',
        'tags' => ['Queens', 'Flushing'],
    ...
    [
        'name' => 'The Jazz Loft',
        'description' => 'Museum and performance space in Stony Brook dedicated to jazz history, hosting live concerts, jam sessions, and educational programs.',
        'address' => '275 Christian Ave, Stony Brook, NY 11790, USA',
        'lat' => 40.919482,
        'lng' => -73.147036,
        'emoji' => '🎷',
        'tags' => ['Long Island', 'Jazz', 'Museum'],
    ],
    [
        'name' => 'Château le Woof',
        'description' => 'Dog-friendly restaurant and event space in Astoria hosting pet-themed events, parties, and community gatherings.',
        'address' => '31-01 Vernon Blvd, Astoria, NY 11106, USA',
        'lat' => 40.769032,
        'lng' => -73.935646,
        'emoji' => '🐕',
        'tags' => ['Queens', 'Astoria'],
    ...
    [
        ...
        'description' => 'French international school on the Upper East Side hosting cultural events, performances, and educational programs.',
        'address' => '505 E 75th St, New York, NY 10021, USA',
        'lat' => 40.768837,
        'lng' => -73.951370,
        'emoji' => '🏫',
        'tags' => ['Manhattan', 'Upper East Side', 'Education'],
    ],
    [
        'name' => 'Stapleton Waterfront Park',
        'description' => 'Waterfront park along the Stapleton Esplanade on Staten Island hosting seasonal festivals, concerts, and community events.',
        'address' => 'Water St, Staten Island, NY 10304, USA',
        'lat' => 40.628972,
        'lng' => -74.072945,
        'emoji' => '🌳',
        'tags' => ['Staten Island', 'Stapleton', 'Park'],
    ],
    [
        'name' => 'En Foco',
        'description' => 'Bronx-based nonprofit supporting contemporary photography by culturally diverse artists, with exhibitions and public programs.',
        'address' => '15 Canal Pl #100, Bronx, NY 10451, USA',
        'lat' => 40.813032,
        'lng' => -73.928024,
        'emoji' => '📷',
        'tags' => ['Bronx', 'Art', 'Photography'],
    ],
    [
        'name' => 'Actionplay',
        'description' => 'Brooklyn-based inclusive arts organization creating accessible theater, games, and interactive experiences for neurodiverse audiences.',
        'address' => '417 Myrtle Ave, Brooklyn, NY 11205, USA',
        'lat' => 40.693289,
        'lng' => -73.969126,
        'emoji' => '🎭',
        'tags' => ['Brooklyn', 'Fort Greene', 'Theatre', 'Community Space'],
    ],
    [
        'name' => 'The Civilians',
        'description' => 'Investigative theater company creating new works that explore civic life, with readings, workshops, and performances.',
        'address' => '138 S Oxford St, Brooklyn, NY 11217, USA',
        'lat' => 40.685136,
        'lng' => -73.973513,
        'emoji' => '🎭',
        'tags' => ['Brooklyn', 'Fort Greene', 'Theatre'],
    ],
    [
        'name' => 'NYC Bird Alliance',
        'description' => 'Conservation organization (formerly NYC Audubon) hosting birding walks, lectures, and nature programs across New York City.',
        'address' => '71 W 23rd St #1523, New York, NY 10010, USA',
        'lat' => 40.742876,
        'lng' => -73.992402,
        'emoji' => '🦆',
        'tags' => ['Manhattan', 'Flatiron'],
    ],
    [
        'name' => 'Secret Room New York',
        'description' => 'Immersive experience venue in Midtown offering escape rooms, interactive shows, and themed entertainment.',
        'address' => '707 8th Ave, New York, NY 10036, USA',
        'lat' => 40.758903,
        'lng' => -73.988972,
        'emoji' => '🎭',
        'tags' => ['Manhattan', 'Midtown', 'Theatre'],
    ],
    [
        'name' => 'The Starving Artist',
        'description' => 'Cafe and gallery on City Island hosting live music, comedy, open mics, and art exhibitions.',
        'address' => '249 City Island Ave, Bronx, NY 10464, USA',
        'lat' => 40.845403,
        'lng' => -73.786048,
        'emoji' => '☕',
        'tags' => ['Bronx', 'City Island', 'Live Music', 'Art'],
    ],
    [
        'name' => 'Lagoon New York',
        'description' => 'Sustainable design store and event space in Bed-Stuy hosting live music, art shows, and community gatherings.',
        'address' => '293 Nostrand Ave, Brooklyn, NY 11216, USA',
        'lat' => 40.688698,
        'lng' => -73.951096,
        'emoji' => '🎨',
        'tags' => ['Brooklyn', 'Bed-Stuy'],
    ],
    [
        'name' => 'Amity Hall (Downtown)',
        'short_name' => 'Amity Hall',
        'description' => 'Gastropub in Greenwich Village with craft beer and event space hosting trivia nights and social meetups.',
    ...
    [
        'name' => 'Serotonin Club Studio',
        'description' => 'Wellness and event studio in the Flatiron District hosting pet events, workshops, and community gatherings.',
        'address' => '14 W 23rd St, New York, NY 10010, USA',
        'lat' => 40.741610,
        'lng' => -73.990359,
        'emoji' => '🐕',
        'tags' => ['Manhattan', 'Flatiron'],
    ...
    [
        ...
        'description' => 'Community center on the Upper East Side providing social services and hosting cultural events, performances, and lectures in its Brooke Astor Auditorium.',
        'address' => '331 E 70th St, New York, NY 10021, USA',
        'lat' => 40.766922,
        'lng' => -73.957670,
        'emoji' => '🫱🏾‍🫲🏼',
        'tags' => ['Manhattan', 'Upper East Side', 'Community Space'],
    ],
    [
        'name' => 'League of American Orchestras',
        'description' => 'National service organization for orchestras hosting conferences, workshops, and industry events.',
        'address' => '520 8th Ave #2203, New York, NY 10018, USA',
        'lat' => 40.753645,
        'lng' => -73.991934,
        'emoji' => '🎵',
        'tags' => ['Manhattan', 'Midtown'],
    ...
    [
        'name' => 'The Pussycat Lounge',
        'description' => 'Bar and performance venue in the Financial District hosting comedy, burlesque, and live entertainment.',
        'address' => '96 Greenwich St, New York, NY 10006, USA',
        'lat' => 40.709304,
        'lng' => -74.013171,
        'emoji' => '🍹',
        'tags' => ['Manhattan', 'Financial District', 'Bar'],
    ...
    [
        'name' => 'CAST North Fork',
        'short_name' => 'CAST',
        'description' => 'Center for Advocacy, Support and Transformation on the North Fork hosting community festivals, events, and outreach programs.',
        'address' => '53930 Main Rd, Southold, NY 11971, USA',
        'lat' => 41.064734,
        'lng' => -72.426913,
        'emoji' => '🫱🏾‍🫲🏼',
        'tags' => ['Long Island', 'Community Space'],
    ],
    // --- Address-based locations ---
    [
        'name' => '210 Canal Street',
        'description' => 'Event space in Chinatown hosting pop-up craft workshops and community gatherings.',
        'address' => '210 Canal St, New York, NY 10013, USA',
        'lat' => 40.717001,
        'lng' => -73.998959,
        'emoji' => '📍',
        'tags' => ['Manhattan', 'Chinatown'],
    ],
    [
        'name' => '26 Federal Plaza',
        'description' => 'Federal government building in Lower Manhattan, site of public hearings, vigils, and civic events.',
        'address' => '26 Federal Plaza, New York, NY 10278, USA',
        'lat' => 40.715263,
        'lng' => -74.003755,
        'emoji' => '🏢',
        'tags' => ['Manhattan', 'Civic Center'],
    ],
    [
        'name' => 'Rubin Museum of Art',
        'description' => 'Museum dedicated to Himalayan art and culture, hosting exhibitions, talks, performances, and meditation programs.',
        'address' => '150 W 17th St, New York, NY 10011, USA',
        'lat' => 40.739964,
        'lng' => -73.997338,
        'emoji' => '🏛️',
        'tags' => ['Manhattan', 'Chelsea', 'Museum', 'Art'],
    ],
];
