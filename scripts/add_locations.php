...
$new_locations = [
    [
        'name' => 'Hekate',
        'description' => 'Intimate sober bar and bottle shop in the East Village serving 0% ABV beers, wines, and alcohol-free cocktails, with regular community events.',
        'address' => '167 Avenue B, New York, NY 10009',
        'lat' => 40.72710,
        'lng' => -73.97944,
        'emoji' => '🍹',
        'tags' => ['Manhattan', 'East Village', 'Bar', 'Community Space'],
    ],
    [
        'name' => 'Accent Sisters',
        'description' => 'Multilingual bookstore, gallery, and cultural space near Union Square hosting screenings, exhibitions, workshops, and literary events.',
        'address' => '89 5th Ave #702, New York, NY 10003',
        'lat' => 40.73751,
        'lng' => -73.99226,
        'emoji' => '📚',
        'tags' => ['Manhattan', 'Union Square', 'Art', 'Gallery', 'Film'],
    ],
];
